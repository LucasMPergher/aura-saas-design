      ...
      >
        ...
        <Card className="bg-aura-night border-aura-smoke/20">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              Unite a AURA y descubrí fragancias exclusivas
            </CardDescription>
          </CardHeader>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="relative">
              ...
              <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-aura-night px-2 text-xs text-muted-foreground">
                O con email
              </span>
            </div>
